            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="expiration" id="expiration" class="form-control" placeholder="" aria-describedby="help-expiration_date" value="<?= old('expiration_date') ?: $target->expiration_date ?>">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="email" id="email" class="form-control" placeholder="" aria-describedby="help-email" value="<?= old('email') ?: $target->email ?>">
