...
<body>
	<div class="card">
		...
		<div class="name">
			...
			<h6 title="Followers"><i class="fas fa-users"></i> <span
					class="followers"><?php echo "@" . $user->username; ?></span></h6>
		</div>
		...
		<div class="ds-skill">
			...
			<h6>Total Number Of Keys in Database:- <i class="fa fa-code" aria-hidden="true"
					style="color:#08f26e;"><?php echo $userDetails3 . " Keys"; ?></i></h6>
			<div class="button">
				<button class="button-85" onclick="buta()" style="margin-top:20px;">Dashboard</button>
			</div>
			<div class="skill html" hidden>
				<h6>Total Number Of Keys Made Till Now <i class="fa fa-code" aria-hidden="true">
						<?php echo $userDetails2 . " Keys"; ?></i></h6>
				<div class="skill html" hidden>
