...
<div class="row">
    ...
    <div class="col-lg-6">
     ...
     <div class="col-lg-6">
        <div class="card shadow h-10 py-2 mb-3">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="email" id="email" class="form-control mt-2" placeholder="" aria-describedby="help-fullname" value="<?= old('email') ?: ($user->email ?: '') ?>">
